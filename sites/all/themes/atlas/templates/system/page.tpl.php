...
<?php if ($page['nav']): ?>
  <div id="nav-section" class="page-section">
    <nav id="primary-nav" class="nav-inline nav-inline-primary clearfix">
...
<?php if ($page['main_prefix']): ?>
  <div id="main-prefix-section" class="page-section">
    <section id="main-prefix" class="clearfix">
...
<div id="main-section" class="page-section">
  <section id="main" class="clearfix" role="main">
    ...
    <?php if ($page['sidebar_first']): ?>
      <section id="sidebar-first" class="sidebar">
        <?php print render($page['sidebar_first']); ?>
      </section>
    <?php endif; ?>
    
    <?php if ($page['sidebar_last']): ?>
      <section id="sidebar-last" class="sidebar">
...
<?php if ($page['main_suffix']): ?>
  <div id="main-suffix-section" class="page-section">
    <section id="main-suffix" class="clearfix">
